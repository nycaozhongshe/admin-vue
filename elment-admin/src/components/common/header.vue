	...
	<div class="header">
		<el-row :gutter="10">
			...
			<el-col :xs="12" :sm="12" :md="4">
				<div class="logo">
					<span class="logo_prefix">学校</span><span class="logo_suffix">Admin</span>
				</div>				
				<div class="website">
				</div>
			</el-col>
			...
			<el-col :xs="12" :sm="12" :md="12">
				<el-menu theme="dark" class="el-menu-demo" mode="horizontal" default-active="1">
					<el-menu-item index="1" @click.native='sliderI("1")'>处理中心</el-menu-item>
					<el-menu-item index="2" @click.native='sliderI("2")'>处理中心2</el-menu-item>
					<el-menu-item index="3" @click.native='sliderI("3")'>处理中心3</el-menu-item>
					<el-menu-item index="4" @click.native='sliderI("4")'>处理中心4</el-menu-item>
				</el-menu>
			</el-col>
			<!-- header right area-->
...
import Bus from '@/status/bus.js'; 
	...
	export default {
		...
		methods: {
			sliderI(index) {
				this.slider = +index
				Bus.$emit('sliderListIndex',this.slider)
			}
		}
	}
</script>
