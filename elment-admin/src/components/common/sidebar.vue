<template>
	<div class="slider-wrapper">
			...
			<el-menu :default-active="onRoutes" class="el-menu-vertical-demo" theme="dark" unique-opened router>
				...
				<el-submenu index="2">
					<template slot="title">
						...
						<span class="sb-cn">Components1</span>

					</template>
					<el-menu-item index="EditorPage">Editor2</el-menu-item>
					<el-menu-item index="MarkdownPage">Markdown2</el-menu-item>
		...
		<div class="sidebar" v-if="silderbarIndex==2">
			...
			<el-menu :default-active="onRoutes" class="el-menu-vertical-demo" theme="dark" unique-opened router>
				...
				<el-submenu index="2">
					<template slot="title">
						<span class="sb-icon"><i class="material-icons">perm_data_setting</i></span>
						<span class="sb-cn">Components2</span>
					</template>
				...
				<el-submenu index="3">
					...
					<el-menu-item index="Tablezhonghe"> Tablezhonghe</el-menu-item>
				</el-submenu>
		...
		<div class="sidebar" v-if="silderbarIndex==3">

			<el-menu :default-active="onRoutes" class="el-menu-vertical-demo" theme="dark" unique-opened router>
				<el-menu-item index="DashBoard">

					<span class="sb-icon"><i class="material-icons">home</i></span>
					<span class="sb-cn">DashBoard3</span>
				</el-menu-item>
				...
				<el-submenu index="2">
					<template slot="title">
						...
						<span class="sb-icon"><i class="material-icons">perm_data_setting</i></span>
						<span class="sb-cn">Components4</span>
		...
		<div class="sidebar" v-if="silderbarIndex==4">

			<el-menu :default-active="onRoutes" class="el-menu-vertical-demo" theme="dark" unique-opened router>
				<el-menu-item index="DashBoard">

					<span class="sb-icon"><i class="material-icons">home</i></span>
					<span class="sb-cn">DashBoard4</span>
				</el-menu-item>
...
<script>
	...
	export default {
		...
		mounted(){
				Bus.$on('sliderListIndex',(index)=>{
						this.silderbarIndex = index
						console.log(this.silderbarIndex)
				})
